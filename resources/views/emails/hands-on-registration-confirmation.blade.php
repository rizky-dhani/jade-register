...
<head>
    ...
    <title>{{ trans('seminar.email_hands_on_registration_confirmation_subject', ['code' => $registration->registration_code]) }}</title>
    <style>
...
<body>
    ...
    <div class="content">
        ...
        <h2>{{ trans('seminar.email_hands_on_registration_confirmation_subject', ['code' => $registration->registration_code]) }}</h2>
        <p>{{ trans('seminar.email_hands_on_registration_received') }}</p>
        ...
        <div class="details">
            ...
            @if($registration->country && $registration->country->name !== 'Indonesia')
        ...
        <div style="text-align: center; margin: 20px 0; padding: 20px; background: #e8f5e9; border-radius: 8px; border: 2px solid #4caf50;">
            ...
            <p style="margin: 0 0 15px 0; color: #888; text-decoration: line-through; font-size: 13px; word-break: break-all;">
                https://chat.whatsapp.com/H6ORdZnLmcM1uhgn0RIh40
            </p>
            <a href="https://chat.whatsapp.com/FOUtwzgjBodABp1TdsEQcH?s=cl&p=a&mlu=4&ilr=4" target="_blank" style="display: inline-block; padding: 12px 24px; background-color: #25d366; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: 600;">
