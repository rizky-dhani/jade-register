<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow border border-blue-200 p-6 text-center">
            <p class="text-6xl font-bold text-blue-600">{{ number_format($totalSeminar) }}</p>
        ...
        <div class="bg-white rounded-lg shadow border border-green-200 p-6 text-center">
            <p class="text-6xl font-bold text-green-600">{{ number_format($totalHandsOn) }}</p>
    ...
    <div class="mb-8">
        <h2 class="text-xl font-semibold text-gray-800 mb-4">{{ __('seminar.seminar') }}</h2>
    ...
    <div>
        <h2 class="text-xl font-semibold text-gray-800 mb-4">{{ __('seminar.hands_on_session') }}</h2>
